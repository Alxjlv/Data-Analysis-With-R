...
* Centre: The mean for price vs energy appears to be linear to a certain extent, and falls within the middle of the data without being pushed to any one side significantly.
* Spread: The spread of our data appears relatively uniform, with most observations clustered around the mean.
* Skew: It is difficult to comment on the skew from this view of the scatter plot but it appears mostly unskewed.
...
```
* Centre: In this updated model, the mean appears bent but still retains a roughly linear shape.
* Spread: The data appears slightly unevenly spread, with the upper end having a wider spread than the lower.
* Skew: Again, it is difficult to comment on the skew, but the data doesn't appear to be clustered too strongly at either end of this scatter plot.
