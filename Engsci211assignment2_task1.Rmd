...
* Skew: Both Yes and No are fairly symmetrical without too significant of a tail.
```{r}
layout20x(1,2)
...
```
An estimate of the mean sleep hours for a student who is not sleep deprived is 7.1 hours (rounded) while an estimate for the mean sleep hours for a student who self reports being sleep deprived is around 6.1 hours
...
The difference between the self reported sleep deprived mean and non self reported sleep deprived group mean is between 0.51 and 1.48 more hours of sleep