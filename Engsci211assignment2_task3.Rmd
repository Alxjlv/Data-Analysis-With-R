...
```
* Centre: Upon log transformation, the median delay for all of the airlines appear to be within about 1 unit of each other - with Delta relatively lower than the other airlines.
